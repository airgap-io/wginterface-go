...
type WireguardLinux struct {
	Wgname string `def:"wg0"`
	Wgpath string `def:"wg0.conf"`
}

func (w WireguardLinux) CreateTunnelInterface() error {
...
func (w WireguardLinux) DeleteTunnelInterface(intfName string) error {
...
func (w WireguardLinux) GetInterfaceStatus(intfName string) (int, error) {
